...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'exercises.doubleWeightCountingTooltip': "Counts this exercise's lifted weight twice for 1RM estimation and progress charts, since the set weight is entered per dumbbell.",
  ...
  de: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Zählt das gehobene Gewicht dieser Übung für die 1RM-Schätzung und den Fortschritts-Chart doppelt, da das Satzgewicht pro Kurzhantel eingegeben wird.',
  ...
  es: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Cuenta el peso levantado de este ejercicio el doble para la estimación de 1RM y el gráfico de progreso, ya que el peso de la serie se introduce por mancuerna.',
  ...
  pt: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Conta o peso levantado deste exercício em dobro para a estimativa de 1RM e o gráfico de progresso, já que o peso da série é inserido por haltere.',
  ...
  it: {
    ...
    'exercises.doubleWeightCountingTooltip': "Conta il peso sollevato di questo esercizio doppio per la stima dell'1RM e il grafico dei progressi, poiché il peso della serie viene inserito per manubrio.",
  ...
  nl: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Telt het getilde gewicht van deze oefening dubbel voor de 1RM-schatting en de voortgangsgrafiek, omdat het gewicht per set per dumbbell wordt ingevoerd.',
  ...
  pl: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Liczy podniesiony ciężar tego ćwiczenia podwójnie na potrzeby szacowania 1RM i wykresu postępów, ponieważ ciężar serii podawany jest na jeden hantel.',
  ...
  ru: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Учитывает поднятый вес этого упражнения вдвое при оценке 1ПМ и на графике прогресса, так как вес подхода вводится на одну гантель.',
  ...
  hu: {
    ...
    'exercises.doubleWeightCountingTooltip': 'Duplán számítja el ennek a gyakorlatnak az emelt súlyát az 1RM becsléséhez és a fejlődési grafikonhoz, mivel a szett súlya egy kézisúlyzóra van megadva.',
