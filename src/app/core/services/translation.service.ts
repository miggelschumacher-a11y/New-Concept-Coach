...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sessions.sessionCountWarmupTooltip': 'When on, warm-up sets count toward the total set count and weight lifted for every exercise in this session. This also checks or unchecks the same option in each exercise\'s own options.',
    'sessions.sessionCountCooldownTooltip': 'When on, cooldown sets count toward the total set count and weight lifted for every exercise in this session. This also checks or unchecks the same option in each exercise\'s own options.',
    'sessions.sessionShowWarmupTooltip': 'When on, the warm-up sets section is shown for every exercise in this session. This also checks or unchecks the same option in each exercise\'s own options.',
    'sessions.sessionShowCooldownTooltip': 'When on, the cooldown sets section is shown for every exercise in this session. This also checks or unchecks the same option in each exercise\'s own options.',
  ...
  de: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Wenn aktiviert, zählen Aufwärmsätze bei jeder Übung dieser Session zur Gesamtzahl der Sätze und zum gehobenen Gewicht. Dies setzt oder entfernt den entsprechenden Haken auch in den Optionen jeder einzelnen Übung.',
    'sessions.sessionCountCooldownTooltip': 'Wenn aktiviert, zählen Cool-Down-Sätze bei jeder Übung dieser Session zur Gesamtzahl der Sätze und zum gehobenen Gewicht. Dies setzt oder entfernt den entsprechenden Haken auch in den Optionen jeder einzelnen Übung.',
    'sessions.sessionShowWarmupTooltip': 'Wenn aktiviert, wird der Bereich für Aufwärmsätze bei jeder Übung dieser Session angezeigt. Dies setzt oder entfernt den entsprechenden Haken auch in den Optionen jeder einzelnen Übung.',
    'sessions.sessionShowCooldownTooltip': 'Wenn aktiviert, wird der Bereich für Cool-Down-Sätze bei jeder Übung dieser Session angezeigt. Dies setzt oder entfernt den entsprechenden Haken auch in den Optionen jeder einzelnen Übung.',
  ...
  es: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Si está activado, las series de calentamiento cuentan para el total de series y el peso levantado en cada ejercicio de esta sesión. Esto también marca o desmarca la misma opción en las opciones de cada ejercicio.',
    'sessions.sessionCountCooldownTooltip': 'Si está activado, las series de enfriamiento cuentan para el total de series y el peso levantado en cada ejercicio de esta sesión. Esto también marca o desmarca la misma opción en las opciones de cada ejercicio.',
    'sessions.sessionShowWarmupTooltip': 'Si está activado, se muestra la sección de series de calentamiento en cada ejercicio de esta sesión. Esto también marca o desmarca la misma opción en las opciones de cada ejercicio.',
    'sessions.sessionShowCooldownTooltip': 'Si está activado, se muestra la sección de series de enfriamiento en cada ejercicio de esta sesión. Esto también marca o desmarca la misma opción en las opciones de cada ejercicio.',
  ...
  pt: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Quando ativado, as séries de aquecimento contam para o total de séries e o peso levantado em todos os exercícios desta sessão. Isso também marca ou desmarca a mesma opção nas opções de cada exercício.',
    'sessions.sessionCountCooldownTooltip': 'Quando ativado, as séries de desaquecimento contam para o total de séries e o peso levantado em todos os exercícios desta sessão. Isso também marca ou desmarca a mesma opção nas opções de cada exercício.',
    'sessions.sessionShowWarmupTooltip': 'Quando ativado, a seção de séries de aquecimento é exibida em todos os exercícios desta sessão. Isso também marca ou desmarca a mesma opção nas opções de cada exercício.',
    'sessions.sessionShowCooldownTooltip': 'Quando ativado, a seção de séries de desaquecimento é exibida em todos os exercícios desta sessão. Isso também marca ou desmarca a mesma opção nas opções de cada exercício.',
  ...
  it: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Se attivo, le serie di riscaldamento contano nel totale delle serie e nel peso sollevato per ogni esercizio di questa sessione. Questo attiva o disattiva anche la stessa opzione nelle opzioni di ogni esercizio.',
    'sessions.sessionCountCooldownTooltip': 'Se attivo, le serie di defaticamento contano nel totale delle serie e nel peso sollevato per ogni esercizio di questa sessione. Questo attiva o disattiva anche la stessa opzione nelle opzioni di ogni esercizio.',
    'sessions.sessionShowWarmupTooltip': 'Se attivo, la sezione delle serie di riscaldamento viene mostrata per ogni esercizio di questa sessione. Questo attiva o disattiva anche la stessa opzione nelle opzioni di ogni esercizio.',
    'sessions.sessionShowCooldownTooltip': 'Se attivo, la sezione delle serie di defaticamento viene mostrata per ogni esercizio di questa sessione. Questo attiva o disattiva anche la stessa opzione nelle opzioni di ogni esercizio.',
  ...
  nl: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Indien actief tellen warming-up sets mee voor het totale aantal sets en het gewicht bij elke oefening in deze sessie. Dit zet ook hetzelfde vinkje aan of uit in de opties van elke oefening.',
    'sessions.sessionCountCooldownTooltip': 'Indien actief tellen cooling-down sets mee voor het totale aantal sets en het gewicht bij elke oefening in deze sessie. Dit zet ook hetzelfde vinkje aan of uit in de opties van elke oefening.',
    'sessions.sessionShowWarmupTooltip': 'Indien actief wordt het gedeelte met warming-up sets getoond bij elke oefening in deze sessie. Dit zet ook hetzelfde vinkje aan of uit in de opties van elke oefening.',
    'sessions.sessionShowCooldownTooltip': 'Indien actief wordt het gedeelte met cooling-down sets getoond bij elke oefening in deze sessie. Dit zet ook hetzelfde vinkje aan of uit in de opties van elke oefening.',
  ...
  pl: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Gdy włączone, serie rozgrzewkowe liczą się do łącznej liczby serii i ciężaru w każdym ćwiczeniu tej sesji. To również zaznacza lub odznacza tę samą opcję w opcjach każdego ćwiczenia.',
    'sessions.sessionCountCooldownTooltip': 'Gdy włączone, serie wyciszające liczą się do łącznej liczby serii i ciężaru w każdym ćwiczeniu tej sesji. To również zaznacza lub odznacza tę samą opcję w opcjach każdego ćwiczenia.',
    'sessions.sessionShowWarmupTooltip': 'Gdy włączone, sekcja serii rozgrzewkowych jest widoczna przy każdym ćwiczeniu tej sesji. To również zaznacza lub odznacza tę samą opcję w opcjach każdego ćwiczenia.',
    'sessions.sessionShowCooldownTooltip': 'Gdy włączone, sekcja serii wyciszających jest widoczna przy każdym ćwiczeniu tej sesji. To również zaznacza lub odznacza tę samą opcję w opcjach każdego ćwiczenia.',
  ...
  ru: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Если включено, разминочные подходы учитываются в общем количестве подходов и весе для каждого упражнения в этой сессии. Это также устанавливает или снимает такую же отметку в настройках каждого упражнения.',
    'sessions.sessionCountCooldownTooltip': 'Если включено, заминочные подходы учитываются в общем количестве подходов и весе для каждого упражнения в этой сессии. Это также устанавливает или снимает такую же отметку в настройках каждого упражнения.',
    'sessions.sessionShowWarmupTooltip': 'Если включено, раздел разминочных подходов отображается для каждого упражнения в этой сессии. Это также устанавливает или снимает такую же отметку в настройках каждого упражнения.',
    'sessions.sessionShowCooldownTooltip': 'Если включено, раздел заминочных подходов отображается для каждого упражнения в этой сессии. Это также устанавливает или снимает такую же отметку в настройках каждого упражнения.',
  ...
  hu: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Ha be van kapcsolva, a bemelegítő szettek beleszámítanak az összes szettbe és a felemelt súlyba a munkamenet minden gyakorlatánál. Ez minden gyakorlat saját beállításaiban is be- vagy kikapcsolja ugyanezt az opciót.',
    'sessions.sessionCountCooldownTooltip': 'Ha be van kapcsolva, a levezető szettek beleszámítanak az összes szettbe és a felemelt súlyba a munkamenet minden gyakorlatánál. Ez minden gyakorlat saját beállításaiban is be- vagy kikapcsolja ugyanezt az opciót.',
    'sessions.sessionShowWarmupTooltip': 'Ha be van kapcsolva, a bemelegítő szettek szakasza megjelenik a munkamenet minden gyakorlatánál. Ez minden gyakorlat saját beállításaiban is be- vagy kikapcsolja ugyanezt az opciót.',
    'sessions.sessionShowCooldownTooltip': 'Ha be van kapcsolva, a levezető szettek szakasza megjelenik a munkamenet minden gyakorlatánál. Ez minden gyakorlat saját beállításaiban is be- vagy kikapcsolja ugyanezt az opciót.',
