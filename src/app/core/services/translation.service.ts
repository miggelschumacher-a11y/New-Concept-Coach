...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sessions.sessionCountWarmupTooltip': 'When on, warm-up sets count toward the total set count and weight lifted for every exercise in this session.',
    'sessions.sessionCountCooldownTooltip': 'When on, cooldown sets count toward the total set count and weight lifted for every exercise in this session.',
    'sessions.sessionShowWarmupTooltip': 'When on, the warm-up sets section is shown for every exercise in this session.',
    'sessions.sessionShowCooldownTooltip': 'When on, the cooldown sets section is shown for every exercise in this session.',
  ...
  de: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Wenn aktiviert, zählen Aufwärmsätze bei jeder Übung dieser Session zur Gesamtzahl der Sätze und zum gehobenen Gewicht.',
    'sessions.sessionCountCooldownTooltip': 'Wenn aktiviert, zählen Cool-Down-Sätze bei jeder Übung dieser Session zur Gesamtzahl der Sätze und zum gehobenen Gewicht.',
    'sessions.sessionShowWarmupTooltip': 'Wenn aktiviert, wird der Bereich für Aufwärmsätze bei jeder Übung dieser Session angezeigt.',
    'sessions.sessionShowCooldownTooltip': 'Wenn aktiviert, wird der Bereich für Cool-Down-Sätze bei jeder Übung dieser Session angezeigt.',
  ...
  es: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Si está activado, las series de calentamiento cuentan para el total de series y el peso levantado en cada ejercicio de esta sesión.',
    'sessions.sessionCountCooldownTooltip': 'Si está activado, las series de enfriamiento cuentan para el total de series y el peso levantado en cada ejercicio de esta sesión.',
    'sessions.sessionShowWarmupTooltip': 'Si está activado, se muestra la sección de series de calentamiento en cada ejercicio de esta sesión.',
    'sessions.sessionShowCooldownTooltip': 'Si está activado, se muestra la sección de series de enfriamiento en cada ejercicio de esta sesión.',
  ...
  pt: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Quando ativado, as séries de aquecimento contam para o total de séries e o peso levantado em todos os exercícios desta sessão.',
    'sessions.sessionCountCooldownTooltip': 'Quando ativado, as séries de desaquecimento contam para o total de séries e o peso levantado em todos os exercícios desta sessão.',
    'sessions.sessionShowWarmupTooltip': 'Quando ativado, a seção de séries de aquecimento é exibida em todos os exercícios desta sessão.',
    'sessions.sessionShowCooldownTooltip': 'Quando ativado, a seção de séries de desaquecimento é exibida em todos os exercícios desta sessão.',
  ...
  it: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Se attivo, le serie di riscaldamento contano nel totale delle serie e nel peso sollevato per ogni esercizio di questa sessione.',
    'sessions.sessionCountCooldownTooltip': 'Se attivo, le serie di defaticamento contano nel totale delle serie e nel peso sollevato per ogni esercizio di questa sessione.',
    'sessions.sessionShowWarmupTooltip': 'Se attivo, la sezione delle serie di riscaldamento viene mostrata per ogni esercizio di questa sessione.',
    'sessions.sessionShowCooldownTooltip': 'Se attivo, la sezione delle serie di defaticamento viene mostrata per ogni esercizio di questa sessione.',
  ...
  nl: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Indien actief tellen warming-up sets mee voor het totale aantal sets en het gewicht bij elke oefening in deze sessie.',
    'sessions.sessionCountCooldownTooltip': 'Indien actief tellen cooling-down sets mee voor het totale aantal sets en het gewicht bij elke oefening in deze sessie.',
    'sessions.sessionShowWarmupTooltip': 'Indien actief wordt het gedeelte met warming-up sets getoond bij elke oefening in deze sessie.',
    'sessions.sessionShowCooldownTooltip': 'Indien actief wordt het gedeelte met cooling-down sets getoond bij elke oefening in deze sessie.',
  ...
  pl: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Gdy włączone, serie rozgrzewkowe liczą się do łącznej liczby serii i ciężaru w każdym ćwiczeniu tej sesji.',
    'sessions.sessionCountCooldownTooltip': 'Gdy włączone, serie wyciszające liczą się do łącznej liczby serii i ciężaru w każdym ćwiczeniu tej sesji.',
    'sessions.sessionShowWarmupTooltip': 'Gdy włączone, sekcja serii rozgrzewkowych jest widoczna przy każdym ćwiczeniu tej sesji.',
    'sessions.sessionShowCooldownTooltip': 'Gdy włączone, sekcja serii wyciszających jest widoczna przy każdym ćwiczeniu tej sesji.',
  ...
  ru: {
    ...
    'sessions.sessionShowWarmupTooltip': 'Если включено, раздел разминочных подходов отображается для каждого упражнения в этой сессии.',
    'sessions.sessionShowCooldownTooltip': 'Если включено, раздел заминочных подходов отображается для каждого упражнения в этой сессии.',
  ...
  hu: {
    ...
    'sessions.sessionCountWarmupTooltip': 'Ha be van kapcsolva, a bemelegítő szettek beleszámítanak az összes szettbe és a felemelt súlyba a munkamenet minden gyakorlatánál.',
    'sessions.sessionCountCooldownTooltip': 'Ha be van kapcsolva, a levezető szettek beleszámítanak az összes szettbe és a felemelt súlyba a munkamenet minden gyakorlatánál.',
    'sessions.sessionShowWarmupTooltip': 'Ha be van kapcsolva, a bemelegítő szettek szakasza megjelenik a munkamenet minden gyakorlatánál.',
    'sessions.sessionShowCooldownTooltip': 'Ha be van kapcsolva, a levezető szettek szakasza megjelenik a munkamenet minden gyakorlatánál.',
