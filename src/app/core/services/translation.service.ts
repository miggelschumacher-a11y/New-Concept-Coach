...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Unchecking this also unchecks \'Count warm-up set\' in this session\'s options.',
    'sessions.exerciseCountCooldownTooltip': 'Unchecking this also unchecks \'Count cooldown set\' in this session\'s options.',
    'sessions.exerciseShowWarmupTooltip': 'Unchecking this also unchecks \'Show warm-up sets\' in this session\'s options.',
    'sessions.exerciseShowCooldownTooltip': 'Unchecking this also unchecks \'Show cooldown sets\' in this session\'s options.',
    'sessions.reps': 'Reps',
  ...
  de: {
    ...
    'sessions.targetRepsField': 'Vorgabe WDH',
    ...
    'sessions.exerciseCountWarmupTooltip': 'Wird dieser Haken entfernt, wird auch „Aufwärmsatz mitzählen“ in den Session-Optionen deaktiviert.',
    'sessions.exerciseCountCooldownTooltip': 'Wird dieser Haken entfernt, wird auch „Cool-Down-Satz mitzählen“ in den Session-Optionen deaktiviert.',
    'sessions.exerciseShowWarmupTooltip': 'Wird dieser Haken entfernt, wird auch „Aufwärmen-Sätze zeigen“ in den Session-Optionen deaktiviert.',
    'sessions.exerciseShowCooldownTooltip': 'Wird dieser Haken entfernt, wird auch „Cool-Down-Sätze zeigen“ in den Session-Optionen deaktiviert.',
    'sessions.reps': 'Wdh.',
  ...
  es: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Al desmarcar esto, también se desmarca «Contar serie de calentamiento» en las opciones de la sesión.',
    'sessions.exerciseCountCooldownTooltip': 'Al desmarcar esto, también se desmarca «Contar serie de enfriamiento» en las opciones de la sesión.',
    'sessions.exerciseShowWarmupTooltip': 'Al desmarcar esto, también se desmarca «Mostrar series de calentamiento» en las opciones de la sesión.',
    'sessions.exerciseShowCooldownTooltip': 'Al desmarcar esto, también se desmarca «Mostrar series de enfriamiento» en las opciones de la sesión.',
    'sessions.reps': 'Reps',
  ...
  pt: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Ao desmarcar isto, também desmarca «Contar série de aquecimento» nas opções da sessão.',
    'sessions.exerciseCountCooldownTooltip': 'Ao desmarcar isto, também desmarca «Contar série de desaquecimento» nas opções da sessão.',
    'sessions.exerciseShowWarmupTooltip': 'Ao desmarcar isto, também desmarca «Mostrar séries de aquecimento» nas opções da sessão.',
    'sessions.exerciseShowCooldownTooltip': 'Ao desmarcar isto, também desmarca «Mostrar séries de desaquecimento» nas opções da sessão.',
    'sessions.reps': 'Reps',
  ...
  it: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Deselezionando questa opzione si disattiva anche «Conta serie di riscaldamento» nelle opzioni della sessione.',
    'sessions.exerciseCountCooldownTooltip': 'Deselezionando questa opzione si disattiva anche «Conta serie di defaticamento» nelle opzioni della sessione.',
    'sessions.exerciseShowWarmupTooltip': 'Deselezionando questa opzione si disattiva anche «Mostra serie di riscaldamento» nelle opzioni della sessione.',
    'sessions.exerciseShowCooldownTooltip': 'Deselezionando questa opzione si disattiva anche «Mostra serie di defaticamento» nelle opzioni della sessione.',
    'sessions.reps': 'Rip.',
  ...
  nl: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Als je dit uitvinkt, wordt ook \'Warming-up set meetellen\' uitgevinkt in de sessieopties.',
    'sessions.exerciseCountCooldownTooltip': 'Als je dit uitvinkt, wordt ook \'Cooling-down set meetellen\' uitgevinkt in de sessieopties.',
    'sessions.exerciseShowWarmupTooltip': 'Als je dit uitvinkt, wordt ook \'Warming-up sets tonen\' uitgevinkt in de sessieopties.',
    'sessions.exerciseShowCooldownTooltip': 'Als je dit uitvinkt, wordt ook \'Cooling-down sets tonen\' uitgevinkt in de sessieopties.',
    'sessions.reps': 'Herh.',
  ...
  pl: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Odznaczenie tego odznacza również „Licz serię rozgrzewkową” w opcjach sesji.',
    'sessions.exerciseCountCooldownTooltip': 'Odznaczenie tego odznacza również „Licz serię wyciszającą” w opcjach sesji.',
    'sessions.exerciseShowWarmupTooltip': 'Odznaczenie tego odznacza również „Pokaż serie rozgrzewkowe” w opcjach sesji.',
    'sessions.exerciseShowCooldownTooltip': 'Odznaczenie tego odznacza również „Pokaż serie wyciszające” w opcjach sesji.',
    'sessions.reps': 'Powt.',
  ...
  ru: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Снятие этой отметки также снимает «Учитывать разминочный подход» в настройках сессии.',
    'sessions.exerciseCountCooldownTooltip': 'Снятие этой отметки также снимает «Учитывать заминочный подход» в настройках сессии.',
    'sessions.exerciseShowWarmupTooltip': 'Снятие этой отметки также снимает «Показывать разминочные подходы» в настройках сессии.',
    'sessions.exerciseShowCooldownTooltip': 'Снятие этой отметки также снимает «Показывать заминочные подходы» в настройках сессии.',
    'sessions.reps': 'Повт.',
  ...
  hu: {
    ...
    'sessions.exerciseCountWarmupTooltip': 'Ha kikapcsolod, a „Bemelegítő sorozat beszámítása” is kikapcsol a munkamenet beállításaiban.',
    'sessions.exerciseCountCooldownTooltip': 'Ha kikapcsolod, a „Levezető sorozat beszámítása” is kikapcsol a munkamenet beállításaiban.',
    'sessions.exerciseShowWarmupTooltip': 'Ha kikapcsolod, a „Bemelegítő sorozatok megjelenítése” is kikapcsol a munkamenet beállításaiban.',
    'sessions.exerciseShowCooldownTooltip': 'Ha kikapcsolod, a „Levezető sorozatok megjelenítése” is kikapcsol a munkamenet beállításaiban.',
    'sessions.reps': 'Ism.',
