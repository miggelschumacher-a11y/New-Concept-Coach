...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'config.firstRestAfterSetTooltip': 'Rest duration until the first reminder',
    'config.secondRestAfterSetLabel': '2nd rest',
    'config.secondRestAfterSetTooltip': 'Additional rest until the second reminder',
  ...
  de: {
    ...
    'config.firstRestAfterSetTooltip': 'Pausendauer bis zur ersten Erinnerung',
    'config.secondRestAfterSetLabel': '2. Pause',
    'config.secondRestAfterSetTooltip': 'Zusätzliche Pause bis zur zweiten Erinnerung',
  ...
  es: {
    ...
    'config.firstRestAfterSetTooltip': 'Duración del descanso hasta el primer aviso',
    'config.secondRestAfterSetLabel': '2.ª pausa',
    'config.secondRestAfterSetTooltip': 'Descanso adicional hasta el segundo aviso',
  ...
  pt: {
    ...
    'config.firstRestAfterSetLabel': '1.ª pausa',
    'config.firstRestAfterSetTooltip': 'Duração da pausa até o primeiro aviso',
    'config.secondRestAfterSetLabel': '2.ª pausa',
    'config.secondRestAfterSetTooltip': 'Pausa adicional até o segundo aviso',
  ...
  it: {
    ...
    'config.firstRestAfterSetTooltip': 'Durata della pausa fino al primo avviso',
    'config.secondRestAfterSetLabel': '2ª pausa',
    'config.secondRestAfterSetTooltip': 'Pausa aggiuntiva fino al secondo avviso',
  ...
  nl: {
    ...
    'config.firstRestAfterSetTooltip': 'Pauzeduur tot de eerste melding',
    'config.secondRestAfterSetLabel': '2e pauze',
    'config.secondRestAfterSetTooltip': 'Extra pauze tot de tweede melding',
  ...
  pl: {
    ...
    'config.firstRestAfterSetTooltip': 'Czas przerwy do pierwszego przypomnienia',
    'config.secondRestAfterSetLabel': '2. przerwa',
    'config.secondRestAfterSetTooltip': 'Dodatkowa przerwa do drugiego przypomnienia',
  ...
  ru: {
    ...
    'config.firstRestAfterSetTooltip': 'Длительность паузы до первого напоминания',
    'config.secondRestAfterSetLabel': '2-я пауза',
    'config.secondRestAfterSetTooltip': 'Дополнительная пауза до второго напоминания',
  ...
  hu: {
    ...
    'config.firstRestAfterSetTooltip': 'Szünet időtartama az első emlékeztetőig',
    'config.secondRestAfterSetLabel': '2. szünet',
    'config.secondRestAfterSetTooltip': 'További szünet a második emlékeztetőig',
